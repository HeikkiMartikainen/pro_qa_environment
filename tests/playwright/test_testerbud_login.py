...
def login_page(page: Page):
    ...
    lp = BudLoginPage(page)
    lp.navigate()
    return lp

def test_tc_basic_01_verify_login_with_valid_credentials(login_page: BudLoginPage):
    """
...
def test_tc_basic_02_verify_login_with_invalid_credentials(login_page: BudLoginPage):
    """
...
def test_tc_basic_04_verify_empty_fields_error_and_button_state(login_page: BudLoginPage):
    """
...
def test_tc_basic_05_verify_password_field_masked(login_page: BudLoginPage):
    """
...
def test_tc_basic_06_verify_username_only_error(login_page: BudLoginPage):
    """
